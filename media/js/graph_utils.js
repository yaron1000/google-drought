graph_utils = {
    ...
    rgbToHex: function(r, g, b) {
        return "#" + graph_utils.componentToHex(r) + graph_utils.componentToHex(g) + graph_utils.componentToHex(b);
    },
    ...
    set_color_bar: function(min,max,palette) {
        ...
        for(var i = 0; i < hex_color_list.length; i++) {
            rgb = graph_utils.hexToRgb('#' + hex_color_list[i]);
            ctx.beginPath();
